    ...
    <fieldset>
        ...
        <fieldset>
          ...
          <div class="divperguntasubjetiva">
            ...
            <div>
                <%: Html.ActionLink("Adicionar Questão", "CriarQuestao", new { id=ViewBag.id_Survey }, new { @class = "button" })%>
            </div>
        </fieldset>
        <br />
        <fieldset>
        ...
        <fieldset>
         ...
         <div class="divperguntasubjetivacomimagem">
            ...
            <div>
                <%: Html.ActionLink("Adicionar Questão", "CriarQuestaoImgObj", new { id=ViewBag.id_Survey }, new { @class = "button" })%>
            </div>
        </fieldset>
        <br />
        <fieldset>
         ...
         <div class="divperguntaobjetivacomcodigo">
            ...
            <div>
                <%: Html.ActionLink("Adicionar Questão", "CriarQuestaoCodObj", new { id=ViewBag.id_Survey }, new { @class = "button" })%>
            </div>
        </fieldset>
        <br />
        <fieldset>
