...
function perguntasubjetiva() {
    ...
    var newItem = $("<div class='editor-field'> Digite sua pergunta: <input class='pergunta' type='text' id='questoes_" + id + "__Pergunta'name='questoes[" + id + "].Pergunta' /><br><p><input value='Remover' class='remover' type='button'/> </div>");
