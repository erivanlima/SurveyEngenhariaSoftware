...
-- --------------------------------------------------
-- Date Created: 02/14/2015 17:10:10
...
CREATE TABLE [dbo].[TB_ENTREVISTADO] (
    [idTB_ENTREVISTADO] int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE [dbo].[TB_ITENS_DA_QUESTAO] (
    [idTB_ITENS_DA_QUESTAO] int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE [dbo].[TB_RESPOSTA] (
    ...
    [TB_ENTREVISTADO_idTB_ENTREVISTADO] int  NULL,
...
ALTER TABLE [dbo].[aspnet_Membership]
ADD CONSTRAINT [FK__aspnet_Me__Appli__3B75D760]
    FOREIGN KEY ([ApplicationId])
    REFERENCES [dbo].[aspnet_Applications]
        ([ApplicationId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Me__Appli__3B75D760'
CREATE INDEX [IX_FK__aspnet_Me__Appli__3B75D760]
...
ALTER TABLE [dbo].[aspnet_Paths]
ADD CONSTRAINT [FK__aspnet_Pa__Appli__6D0D32F4]
    FOREIGN KEY ([ApplicationId])
    REFERENCES [dbo].[aspnet_Applications]
        ([ApplicationId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Pa__Appli__6D0D32F4'
CREATE INDEX [IX_FK__aspnet_Pa__Appli__6D0D32F4]
ON [dbo].[aspnet_Paths]
    ([ApplicationId]);
GO
...
ALTER TABLE [dbo].[aspnet_Roles]
ADD CONSTRAINT [FK__aspnet_Ro__Appli__59FA5E80]
    FOREIGN KEY ([ApplicationId])
    REFERENCES [dbo].[aspnet_Applications]
        ([ApplicationId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Ro__Appli__59FA5E80'
CREATE INDEX [IX_FK__aspnet_Ro__Appli__59FA5E80]
ON [dbo].[aspnet_Roles]
    ([ApplicationId]);
GO
...
ALTER TABLE [dbo].[aspnet_Users]
ADD CONSTRAINT [FK__aspnet_Us__Appli__2B3F6F97]
    FOREIGN KEY ([ApplicationId])
    REFERENCES [dbo].[aspnet_Applications]
        ([ApplicationId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Us__Appli__2B3F6F97'
CREATE INDEX [IX_FK__aspnet_Us__Appli__2B3F6F97]
ON [dbo].[aspnet_Users]
    ([ApplicationId]);
GO
...
ALTER TABLE [dbo].[aspnet_Membership]
ADD CONSTRAINT [FK__aspnet_Me__UserI__3C69FB99]
    FOREIGN KEY ([UserId])
...
ALTER TABLE [dbo].[aspnet_PersonalizationAllUsers]
ADD CONSTRAINT [FK__aspnet_Pe__PathI__72C60C4A]
    FOREIGN KEY ([PathId])
...
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser]
ADD CONSTRAINT [FK__aspnet_Pe__PathI__76969D2E]
    FOREIGN KEY ([PathId])
    REFERENCES [dbo].[aspnet_Paths]
        ([PathId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Pe__PathI__76969D2E'
CREATE INDEX [IX_FK__aspnet_Pe__PathI__76969D2E]
...
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser]
ADD CONSTRAINT [FK__aspnet_Pe__UserI__778AC167]
    FOREIGN KEY ([UserId])
    REFERENCES [dbo].[aspnet_Users]
        ([UserId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK__aspnet_Pe__UserI__778AC167'
CREATE INDEX [IX_FK__aspnet_Pe__UserI__778AC167]
ON [dbo].[aspnet_PersonalizationPerUser]
    ([UserId]);
GO
...
ALTER TABLE [dbo].[aspnet_Profile]
ADD CONSTRAINT [FK__aspnet_Pr__UserI__5070F446]
    FOREIGN KEY ([UserId])
    REFERENCES [dbo].[aspnet_Users]
        ([UserId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
