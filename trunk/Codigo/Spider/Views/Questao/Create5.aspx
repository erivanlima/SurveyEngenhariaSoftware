...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Create5", "Questao", FormMethod.Post, new { enctype = "multipart/form-data" }))
       { %>
    ...
    <div>
<%--        <%: Html.ActionLink("Voltar", "ModeloQuestões", "Questao", new { id = Model.id_Survey }, new { @class = "button" })%>--%>
    </div>
