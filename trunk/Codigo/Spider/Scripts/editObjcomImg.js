...
function addimg() {
    ...
    $('.adicionar').click(function () {
        ...
        var newItem = $("<div class='editor-field'> Nome do item: <input  type='text' id='itensAux_" + id + "__Item'name='itensAux[" + id + "].Item' /> <input value='Remover' class='removeritens' type='button'/></div>");
        $(".item").append(newItem);
