...
CREATE TABLE TB_QUESTAO (
  ...
  INDEX TB_QUESTÃO_FKIndex1(TB_SURVEY_id_Survey),
  INDEX TB_QUESTAO_FKIndex2(TB_ITENS_DA_QUESTAO_idTB_ITENS_DA_QUESTAO)
);
...
CREATE TABLE TB_RESPOSTA (
  ...
  INDEX TB_RESPOSTA_FKIndex1(TB_QUESTAO_id_Questao),
  INDEX TB_RESPOSTA_FKIndex2(TB_ENTREVISTADO_idTB_ENTREVISTADO)
);
...
CREATE TABLE TB_SURVEY (
  ...
  INDEX TB_SURVEY_FKIndex1(TB_RESPONSAVEL_id_Responsavel)
);
